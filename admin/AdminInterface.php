			...
			<div class="container-fluid">
				<div class="row">
					...
					<ul class="navbar-nav flex-column mt-4">
						...
						<li class="nav-item"><a href="http://localhost/Craft_Pop_House_DP2/admin/slide.php" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fa fa-bell text-light fa-lg mr-3"></i>Edit Announcement</a></li>
					</ul>
