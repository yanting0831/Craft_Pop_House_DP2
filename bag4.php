		...
		<h2>Related Products</h2>
			...
			<div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
				...
				<img class="card-img-top" src="images/bag-1.jpg" alt="...">
					...
					<p>This gorgeous hand crafted rattan handbag allows you to bring everything with you whenever you need to, but fashionably of course! Get compliments from everyone on the gorgeous gold hardware on this stunning bag.<br></br></p>
			...
			<div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
				...
				<img src="images/bag-2.jpg" alt="...">
					...
					<p>This beautiful rattan crossbody bag by Craft Pop House allows you to bring everything with you whenever you need to, but fashionably of course! Get compliments from everyone on the gorgeous gold hardware on this stunning bag.</p>
			...
			<div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
				...
				<img src="images/bag-3.jpg" alt="...">
					<div class="caption">
					<h3>Handmade Top-Handle Bag</h3>
					<p>This traditional rattan made handbag allows you to bring everything in this simplistic and fashion design bag. This bag is designed by our top seller Sofia. Get compliments from your friend and family on this gorgeous gold hardware on this stunning bag.<br></br></p>
