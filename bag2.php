...
<body>
	...
	<div class="soap">
		<img src="images/bag-2.jpg" alt="handicraft soap" class="charcoal">
		<h2>Handmade Rattan Crossbody Bag</h2>
		...
		<h2>Related Products</h2>
			...
			<div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
				...
				<img class="card-img-top" src="images/bag-1.jpg" alt="...">
					...
					<p>This gorgeous hand crafted rattan handbag by our top designer David allows you to bring everything with you whenever you need to, but fashionably of course! Grab this beautiful hand crafted rattan made for yourself or your loved ones before its too late!</p>
