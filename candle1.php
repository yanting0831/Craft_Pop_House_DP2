...
<body>
	...
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page"> All is Bright Large Jar Candle</li>
	  </ol>
	</nav>
	
	<div class="soap">
		<img src="images/candle-1.jpg" alt="handicraft soap" class="candle">
		<h2> All is Bright Jar Candle</h2>
	...
	<div class="container">
		<h2>Related Products</h2>
			...
			<div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
				<div class="thumbnail">
				<img class="card-img-top" src="images/candle-3.jpg" alt="candle">
					<div class="caption">
			...
			<div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
				...
				<img src="images/candle-2.jpg" alt="candle">
					...
					<p>Always in good taste … a sophisticated and soothing blend of florals and subtle fruits. </p>
					<br></br>
					<p><b>Fragrance Notes:</b></p>
					<p><b>Top: </b>Sheer Citrus, Aldehydes, Greens</p>
					<p><b>Mid: </b>Mimosa, Ylang, Jasmine, Rose, Tuberose</p>
			...
			<div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
				<div class="thumbnail">
				<img src="images/candle-4.jpg" alt="candle">
					<div class="caption">
					<h3>A Calm & Quiet Place Jar Candle</h3>
					<p>A meditative fragrance - balanced and entered with gentle jasmine, a whisper of patchouli and warm amber musk.</p>
					<p><b>Fragrance Notes:</b></p>
