			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="bottom-border pb-3">
						...
						<a href="#" class="text-white">Seller</a>
						</div>
					<ul class="navbar-nav flex-column mt-4">
						...
						<li class="nav-item"><a href="http://localhost/Craft_Pop_House_DP2/" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fa fa-book text-light fa-lg mr-3"></i>Shop Page</a></li>
					</ul>
