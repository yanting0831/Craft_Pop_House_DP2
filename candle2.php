...
<body>
	...
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Aloe Water Jar Candle</li>
	  </ol>
	</nav>
	
	<div class="soap">
		<img src="images/candle-2.jpg" alt="handicraft soap" class="charcoal">
		<h2>Aloe Water Jar Candle</h2>
	...
	<div class="container">
		<h2>Related Products</h2>
			...
			<div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
				<div class="thumbnail">
				<img src="images/candle-3.jpg" alt="...">
					<div class="caption">
