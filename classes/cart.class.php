<?php
    class cart {
        ...
        public function addItem() {
            $sql = "INSERT INTO `cart`(`id`, `cid`, `pid`, `title`, `quantity`, `totalAmount`) VALUES (null,:cid,:pid,:title,:quantity,:totalAmount)";
        ...
        public function getAllCartItems() {
            $sql  = "SELECT c.*, p.product_price, p.product_img FROM cart c JOIN products p on c.pid = p.product_id WHERE cid = :cid";
